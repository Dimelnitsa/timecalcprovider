...
/// calculation start time of items
  void calculateStartTimeOfItems(TimeSet timeSet) {
       DateTime startDateTimeOfItem = DateTime(
        0, 1, 1, timeSet.startHours, timeSet.startMinutes, 0);
    ...
    for (int i = 0; i < countOfItems; i++) {
      ...
      _itemsDataProvider.saveItemInHive(timeSet.items![i]);
    }
  }
  ...
  void _calcAverageDurationOfItem(TimeSet timeSet) {
    ...
    _averageDurationOfItem = _dateTimeFormatDurationInMinutes(averageDurationOfItemInMinutes);

    //saveAverageDurationOfItem(countOfItems,durationOfItemHours, durationOfItemMinutes, durationOfItemSeconds);
  }
/// TODO fix the ex Unsupported operation: Infinity or NaN toInt.
  DateTime _dateTimeFormatDurationInMinutes(double minutes) {
    var convertInHours = minutes/60;
    int durationOfItemHours = convertInHours.ceil();
  ...
  //   });
    ...
    void changeDurationOfItems(TimeSet timeSet){
      ...
      _itemsDataProvider.setAverageDurationOfItem(timeSet, _averageDurationOfItem);
    }
}
